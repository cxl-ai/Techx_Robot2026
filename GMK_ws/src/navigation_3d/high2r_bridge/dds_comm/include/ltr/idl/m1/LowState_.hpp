...
*****************************************************************/
#ifndef DDSCXX_LTR_IDL_M1_LOWSTATE__HPP
#define DDSCXX_LTR_IDL_M1_LOWSTATE__HPP

#include "ltr/idl/m1/BmsState_.hpp"

#include "ltr/idl/m1/IMUState_.hpp"

#include "ltr/idl/m1/MotorState_.hpp"
...
private:
 ...
 ::ltr_m1::msg::dds_::IMUState_ imu_state_;
 std::array<::ltr_m1::msg::dds_::MotorState_, 20> motor_state_ = { };
 ::ltr_m1::msg::dds_::BmsState_ bms_state_;
...
public:
  ...
  explicit LowState_(
    ...
    uint16_t bandwidth,
    const ::ltr_m1::msg::dds_::IMUState_& imu_state,
    const std::array<::ltr_m1::msg::dds_::MotorState_, 20>& motor_state,
    const ::ltr_m1::msg::dds_::BmsState_& bms_state,
  ...
  const ::ltr_m1::msg::dds_::IMUState_& imu_state() const { return this->imu_state_; }
  ::ltr_m1::msg::dds_::IMUState_& imu_state() { return this->imu_state_; }
  void imu_state(const ::ltr_m1::msg::dds_::IMUState_& _val_) { this->imu_state_ = _val_; }
  void imu_state(::ltr_m1::msg::dds_::IMUState_&& _val_) { this->imu_state_ = _val_; }
  const std::array<::ltr_m1::msg::dds_::MotorState_, 20>& motor_state() const { return this->motor_state_; }
  std::array<::ltr_m1::msg::dds_::MotorState_, 20>& motor_state() { return this->motor_state_; }
  void motor_state(const std::array<::ltr_m1::msg::dds_::MotorState_, 20>& _val_) { this->motor_state_ = _val_; }
  void motor_state(std::array<::ltr_m1::msg::dds_::MotorState_, 20>&& _val_) { this->motor_state_ = _val_; }
  const ::ltr_m1::msg::dds_::BmsState_& bms_state() const { return this->bms_state_; }
  ::ltr_m1::msg::dds_::BmsState_& bms_state() { return this->bms_state_; }
  void bms_state(const ::ltr_m1::msg::dds_::BmsState_& _val_) { this->bms_state_ = _val_; }
  void bms_state(::ltr_m1::msg::dds_::BmsState_&& _val_) { this->bms_state_ = _val_; }
...
template <> constexpr const char* TopicTraits<::ltr_m1::msg::dds_::LowState_>::getTypeName()
{
  return "ltr_m1::msg::dds_::LowState_";
}

template <> constexpr bool TopicTraits<::ltr_m1::msg::dds_::LowState_>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::ltr_m1::msg::dds_::LowState_>::type_map_blob_sz() { return 3184; }
template<> constexpr unsigned int TopicTraits<::ltr_m1::msg::dds_::LowState_>::type_info_blob_sz() { return 244; }
template<> inline const uint8_t * TopicTraits<::ltr_m1::msg::dds_::LowState_>::type_map_blob() {
...
template<> inline const uint8_t * TopicTraits<::ltr_m1::msg::dds_::LowState_>::type_info_blob() {
  static const uint8_t blob[] = {
...
template <>
struct topic_type_name<::ltr_m1::msg::dds_::LowState_>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::ltr_m1::msg::dds_::LowState_>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::ltr_m1::msg::dds_::LowState_)
...
template<>
inline propvec &get_type_props<::ltr_m1::msg::dds_::LowState_>() {
  ...
  props.push_back(entity_properties_t(1, 0, false, bb_unset, extensibility::ext_final, false));  //::head
  props.push_back(entity_properties_t(1, 1, false, bb_unset, extensibility::ext_final, false));  //::level_flag
  props.push_back(entity_properties_t(1, 2, false, bb_unset, extensibility::ext_final, false));  //::frame_reserve
  props.push_back(entity_properties_t(1, 3, false, bb_unset, extensibility::ext_final, false));  //::sn
  props.push_back(entity_properties_t(1, 4, false, bb_unset, extensibility::ext_final, false));  //::version
  props.push_back(entity_properties_t(1, 5, false, bb_unset, extensibility::ext_final, false));  //::bandwidth
  props.push_back(entity_properties_t(1, 6, false, bb_unset, extensibility::ext_final, false));  //::imu_state
  props.push_back(entity_properties_t(1, 7, false, bb_unset, extensibility::ext_final, false));  //::motor_state
  props.push_back(entity_properties_t(1, 8, false, bb_unset, extensibility::ext_final, false));  //::bms_state
  props.push_back(entity_properties_t(1, 9, false, bb_unset, extensibility::ext_final, false));  //::foot_force
  props.push_back(entity_properties_t(1, 10, false, bb_unset, extensibility::ext_final, false));  //::foot_force_est
  props.push_back(entity_properties_t(1, 11, false, bb_unset, extensibility::ext_final, false));  //::tick
  props.push_back(entity_properties_t(1, 12, false, bb_unset, extensibility::ext_final, false));  //::wireless_remote
  props.push_back(entity_properties_t(1, 13, false, bb_unset, extensibility::ext_final, false));  //::bit_flag
  props.push_back(entity_properties_t(1, 14, false, bb_unset, extensibility::ext_final, false));  //::adc_reel
  props.push_back(entity_properties_t(1, 15, false, bb_unset, extensibility::ext_final, false));  //::temperature_ntc1
  props.push_back(entity_properties_t(1, 16, false, bb_unset, extensibility::ext_final, false));  //::temperature_ntc2
  props.push_back(entity_properties_t(1, 17, false, bb_unset, extensibility::ext_final, false));  //::power_v
  props.push_back(entity_properties_t(1, 18, false, bb_unset, extensibility::ext_final, false));  //::power_a
  props.push_back(entity_properties_t(1, 19, false, bb_unset, extensibility::ext_final, false));  //::fan_frequency
  props.push_back(entity_properties_t(1, 20, false, bb_unset, extensibility::ext_final, false));  //::reserve
  props.push_back(entity_properties_t(1, 21, false, bb_unset, extensibility::ext_final, false));  //::crc
...
bool write(T& streamer, const ::ltr_m1::msg::dds_::LowState_& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::ltr_m1::msg::dds_::LowState_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_m1::msg::dds_::LowState_>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::ltr_m1::msg::dds_::LowState_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::ltr_m1::msg::dds_::LowState_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_m1::msg::dds_::LowState_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::ltr_m1::msg::dds_::LowState_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::ltr_m1::msg::dds_::LowState_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_m1::msg::dds_::LowState_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::ltr_m1::msg::dds_::LowState_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::ltr_m1::msg::dds_::LowState_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_m1::msg::dds_::LowState_>();
...
#endif // DDSCXX_LTR_IDL_M1_LOWSTATE__HPP
