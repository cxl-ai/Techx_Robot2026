...
*****************************************************************/
#ifndef DDSCXX_LTR_IDL_M1_LOWCMD__HPP
#define DDSCXX_LTR_IDL_M1_LOWCMD__HPP

#include "ltr/idl/m1/BmsCmd_.hpp"

#include "ltr/idl/m1/MotorCmd_.hpp"
...
private:
 ...
 std::array<::ltr_m1::msg::dds_::MotorCmd_, 20> motor_cmd_ = { };
 ::ltr_m1::msg::dds_::BmsCmd_ bms_cmd_;
...
public:
  ...
  explicit LowCmd_(
    ...
    uint16_t bandwidth,
    const std::array<::ltr_m1::msg::dds_::MotorCmd_, 20>& motor_cmd,
    const ::ltr_m1::msg::dds_::BmsCmd_& bms_cmd,
  ...
  const std::array<::ltr_m1::msg::dds_::MotorCmd_, 20>& motor_cmd() const { return this->motor_cmd_; }
  std::array<::ltr_m1::msg::dds_::MotorCmd_, 20>& motor_cmd() { return this->motor_cmd_; }
  void motor_cmd(const std::array<::ltr_m1::msg::dds_::MotorCmd_, 20>& _val_) { this->motor_cmd_ = _val_; }
  void motor_cmd(std::array<::ltr_m1::msg::dds_::MotorCmd_, 20>&& _val_) { this->motor_cmd_ = _val_; }
  const ::ltr_m1::msg::dds_::BmsCmd_& bms_cmd() const { return this->bms_cmd_; }
  ::ltr_m1::msg::dds_::BmsCmd_& bms_cmd() { return this->bms_cmd_; }
  void bms_cmd(const ::ltr_m1::msg::dds_::BmsCmd_& _val_) { this->bms_cmd_ = _val_; }
  void bms_cmd(::ltr_m1::msg::dds_::BmsCmd_&& _val_) { this->bms_cmd_ = _val_; }
...
template <> constexpr const char* TopicTraits<::ltr_m1::msg::dds_::LowCmd_>::getTypeName()
{
  return "ltr_m1::msg::dds_::LowCmd_";
}

template <> constexpr bool TopicTraits<::ltr_m1::msg::dds_::LowCmd_>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::ltr_m1::msg::dds_::LowCmd_>::type_map_blob_sz() { return 1710; }
template<> constexpr unsigned int TopicTraits<::ltr_m1::msg::dds_::LowCmd_>::type_info_blob_sz() { return 196; }
template<> inline const uint8_t * TopicTraits<::ltr_m1::msg::dds_::LowCmd_>::type_map_blob() {
...
template<> inline const uint8_t * TopicTraits<::ltr_m1::msg::dds_::LowCmd_>::type_info_blob() {
  static const uint8_t blob[] = {
...
template <>
struct topic_type_name<::ltr_m1::msg::dds_::LowCmd_>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::ltr_m1::msg::dds_::LowCmd_>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::ltr_m1::msg::dds_::LowCmd_)
...
template<>
inline propvec &get_type_props<::ltr_m1::msg::dds_::LowCmd_>() {
  ...
  props.push_back(entity_properties_t(1, 6, false, bb_unset, extensibility::ext_final, false));  //::motor_cmd
  props.push_back(entity_properties_t(1, 7, false, bb_unset, extensibility::ext_final, false));  //::bms_cmd
  props.push_back(entity_properties_t(1, 8, false, bb_unset, extensibility::ext_final, false));  //::wireless_remote
  props.push_back(entity_properties_t(1, 9, false, bb_unset, extensibility::ext_final, false));  //::led
  props.push_back(entity_properties_t(1, 10, false, bb_unset, extensibility::ext_final, false));  //::fan
  props.push_back(entity_properties_t(1, 11, false, bb_unset, extensibility::ext_final, false));  //::gpio
  props.push_back(entity_properties_t(1, 12, false, bb_unset, extensibility::ext_final, false));  //::reserve
  props.push_back(entity_properties_t(1, 13, false, bb_unset, extensibility::ext_final, false));  //::crc
...
bool write(T& streamer, const ::ltr_m1::msg::dds_::LowCmd_& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::ltr_m1::msg::dds_::LowCmd_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_m1::msg::dds_::LowCmd_>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::ltr_m1::msg::dds_::LowCmd_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::ltr_m1::msg::dds_::LowCmd_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_m1::msg::dds_::LowCmd_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::ltr_m1::msg::dds_::LowCmd_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::ltr_m1::msg::dds_::LowCmd_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_m1::msg::dds_::LowCmd_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::ltr_m1::msg::dds_::LowCmd_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::ltr_m1::msg::dds_::LowCmd_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_m1::msg::dds_::LowCmd_>();
...
#endif // DDSCXX_LTR_IDL_M1_LOWCMD__HPP
