#ifndef __LTR_OS_HPP__
#define __LTR_OS_HPP__
...
namespace common
{
enum LTR_SCHED_POLICY
{
    LTR_SCHED_POLICY_NORMAL = SCHED_OTHER,
    LTR_SCHED_POLICY_FIFO = SCHED_FIFO,
    LTR_SCHED_POLICY_RR = SCHED_RR,
    LTR_SCHED_POLICY_BATCH = SCHED_BATCH,
    LTR_SCHED_POLICY_IDLE = SCHED_IDLE,
    LTR_SCHED_POLICY_DEADLINE = SCHED_DEADLINE
};
