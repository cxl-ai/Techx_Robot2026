#ifndef __LTR_ROBOT_SDK_CHANNEL_FACTORY_HPP__
#define __LTR_ROBOT_SDK_CHANNEL_FACTORY_HPP__

#include <ltr/common/dds/dds_factory_model.hpp>
...
using Channel = ltr::common::DdsTopicChannel<MSG>;

template<typename MSG>
using ChannelPtr = ltr::common::DdsTopicChannelPtr<MSG>;
...
#endif//__LTR_ROBOT_SDK_CHANNEL_FACTORY_HPP__
