...
{
private:
 ::ltr_api::msg::dds_::RequestIdentity_ identity_;
 ::ltr_api::msg::dds_::RequestLease_ lease_;
 ::ltr_api::msg::dds_::RequestPolicy_ policy_;

public:
  RequestHeader_() = default;

  explicit RequestHeader_(
    const ::ltr_api::msg::dds_::RequestIdentity_& identity,
    const ::ltr_api::msg::dds_::RequestLease_& lease,
    const ::ltr_api::msg::dds_::RequestPolicy_& policy) :
    identity_(identity),
    lease_(lease),
    policy_(policy) { }

  const ::ltr_api::msg::dds_::RequestIdentity_& identity() const { return this->identity_; }
  ::ltr_api::msg::dds_::RequestIdentity_& identity() { return this->identity_; }
  void identity(const ::ltr_api::msg::dds_::RequestIdentity_& _val_) { this->identity_ = _val_; }
  void identity(::ltr_api::msg::dds_::RequestIdentity_&& _val_) { this->identity_ = _val_; }
  const ::ltr_api::msg::dds_::RequestLease_& lease() const { return this->lease_; }
  ::ltr_api::msg::dds_::RequestLease_& lease() { return this->lease_; }
  void lease(const ::ltr_api::msg::dds_::RequestLease_& _val_) { this->lease_ = _val_; }
  void lease(::ltr_api::msg::dds_::RequestLease_&& _val_) { this->lease_ = _val_; }
  const ::ltr_api::msg::dds_::RequestPolicy_& policy() const { return this->policy_; }
  ::ltr_api::msg::dds_::RequestPolicy_& policy() { return this->policy_; }
  void policy(const ::ltr_api::msg::dds_::RequestPolicy_& _val_) { this->policy_ = _val_; }
  void policy(::ltr_api::msg::dds_::RequestPolicy_&& _val_) { this->policy_ = _val_; }
...
template <> constexpr const char* TopicTraits<::ltr_api::msg::dds_::RequestHeader_>::getTypeName()
{
  return "ltr_api::msg::dds_::RequestHeader_";
}

template <> constexpr bool TopicTraits<::ltr_api::msg::dds_::RequestHeader_>::isKeyless()
{
  return true;
}

#ifdef DDSCXX_HAS_TYPE_DISCOVERY
template<> constexpr unsigned int TopicTraits<::ltr_api::msg::dds_::RequestHeader_>::type_map_blob_sz() { return 1064; }
template<> constexpr unsigned int TopicTraits<::ltr_api::msg::dds_::RequestHeader_>::type_info_blob_sz() { return 244; }
template<> inline const uint8_t * TopicTraits<::ltr_api::msg::dds_::RequestHeader_>::type_map_blob() {
...
template<> inline const uint8_t * TopicTraits<::ltr_api::msg::dds_::RequestHeader_>::type_info_blob() {
  static const uint8_t blob[] = {
...
template <>
struct topic_type_name<::ltr_api::msg::dds_::RequestHeader_>
{
    static std::string value()
    {
      return org::eclipse::cyclonedds::topic::TopicTraits<::ltr_api::msg::dds_::RequestHeader_>::getTypeName();
    }
};
...
REGISTER_TOPIC_TYPE(::ltr_api::msg::dds_::RequestHeader_)
...
template<>
inline propvec &get_type_props<::ltr_api::msg::dds_::RequestHeader_>() {
  ...
  props.push_back(entity_properties_t(1, 0, false, bb_unset, extensibility::ext_final, false));  //::identity
  props.push_back(entity_properties_t(1, 1, false, bb_unset, extensibility::ext_final, false));  //::lease
  props.push_back(entity_properties_t(1, 2, false, bb_unset, extensibility::ext_final, false));  //::policy

  entity_properties_t::finish(props, keylist);
  
  // Manually set first_member for nested types to ensure correct deserialization
  // Force initialization of nested type props
  auto &identity_props = get_type_props<::ltr_api::msg::dds_::RequestIdentity_>();
  auto &lease_props = get_type_props<::ltr_api::msg::dds_::RequestLease_>();
  auto &policy_props = get_type_props<::ltr_api::msg::dds_::RequestPolicy_>();
  
  // Set first_member for nested types (identity is at index 1, lease at 2, policy at 3)
  if (props.size() > 1 && identity_props.size() > 0) {
    props[1].first_member = identity_props.data();
  }
  if (props.size() > 2 && lease_props.size() > 0) {
    props[2].first_member = lease_props.data();
  }
  if (props.size() > 3 && policy_props.size() > 0) {
    props[3].first_member = policy_props.data();
  }
...
bool write(T& streamer, const ::ltr_api::msg::dds_::RequestHeader_& instance, entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::ltr_api::msg::dds_::RequestHeader_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_api::msg::dds_::RequestHeader_>();
  str.set_mode(cdr_stream::stream_mode::write, as_key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::ltr_api::msg::dds_::RequestHeader_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::ltr_api::msg::dds_::RequestHeader_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_api::msg::dds_::RequestHeader_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::ltr_api::msg::dds_::RequestHeader_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::ltr_api::msg::dds_::RequestHeader_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_api::msg::dds_::RequestHeader_>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::ltr_api::msg::dds_::RequestHeader_& instance, entity_properties_t *props) {
  (void)instance;
  if (!streamer.start_struct(*props))
    return false;
  auto prop = streamer.first_entity(props);
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::ltr_api::msg::dds_::RequestHeader_& instance, bool as_key) {
  auto &props = get_type_props<::ltr_api::msg::dds_::RequestHeader_>();
